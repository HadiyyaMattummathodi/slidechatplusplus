...
data_path = r"/home/ai-11/Public/SlideChat Model/SlideChat/dataset/SlideBench/SlideBench-VQA-TCGA_smaller.csv"
...
model = dict(
    ...
    train_stage='2',
    encoder_name='LongNet_2_layers_512_dim', # <--- Add the required value here!

    use_focus=True,  #FOCUS TOGGLE
    llm=dict(
...
llava_dataset = dict(
    type=LLaVADataset,
    data_path=data_path,
    image_folder = r'/home/ai-11/Public/SlideChat Model/SlideChat/dataset/WSI_feat/',
