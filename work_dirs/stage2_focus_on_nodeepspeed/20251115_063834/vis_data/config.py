...
custom_hooks = [
    ...
    dict(
        evaluation_images=
        '/home/ai-11/Public/SlideChat Model/SlideChat/dataset/WSI_feat/TCGA-A7-A0CJ-01Z-00-DX2.csv',
        evaluation_inputs=[
...
data_path = '/home/ai-11/Public/SlideChat Model/SlideChat/dataset/train_data_example.json'
...
llava_dataset = dict(
    data_path=
    '/home/ai-11/Public/SlideChat Model/SlideChat/dataset/train_data_example.json',
...
warmup_ratio = 0.03
weight_decay = 0
work_dir = 'work_dirs/stage2_focus_on_nodeepspeed'
